...
import type { ErrorBiDiCommandResponse, SuccessBiDiCommandResponse, ExternalDriver } from '@appium/types';
 ...
 * @param driver
 */
export declare function onBidiMessage(this: AppiumDriver, data: Buffer, driver: AnyDriver): Promise<SuccessBiDiCommandResponse | ErrorBiDiCommandResponse>;
/**
